...
const pages = {
  overview: ['營運總覽', overviewPage], manager: ['AI 店長', managerPage], orders: ['訂單管理', ()=>listPage('orders')], products: ['商品與庫存', ()=>listPage('products')], customers: ['顧客', ()=>listPage('customers')], marketing: ['行銷活動', ()=>listPage('marketing')], analytics: ['營運分析', analyticsPage], experiments: ['策略評測', experimentsPage], settings: ['商店設定', settingsPage]
};
